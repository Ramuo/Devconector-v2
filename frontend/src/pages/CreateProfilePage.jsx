...
import { useCreateProfileMutation } from '../slices/profileApiSlice';
...
const CreateProfilePage = () => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    try {
      await createProfile({company, website, location, status, skills, githubusername, bio, twitter, facebook, linkedin, instagram, youtube}).unwrap();
      toast.success('Profil créé où mis à joour avec succès ');
      navigate('/dashboard');
    } catch (err) {
